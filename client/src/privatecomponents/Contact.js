...
const Contact = () => {
    ...
    const deletequery = id =>{
        axios.delete(`http://localhost:5000/deletequery/${id}`,{headers : {'x-token' : localStorage.getItem('token')}}).then(
    ...
    useEffect(()=>{
        ...
        axios.get('http://localhost:5000/getquery',{headers : {'x-token' : localStorage.getItem('token')}}).then(

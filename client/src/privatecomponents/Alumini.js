...
const Alumini = () => {
    ...
    useEffect(()=>{
        ...
        axios.get('http://localhost:5000/allaluminis',{headers : {'x-token' : localStorage.getItem('token')}}).then(res => 
    ...
    const aluminisubmithandler = e =>{
        ...
        {
            axios.post("http://localhost:5000/aluminiregister",aluminidata).then(
                res => { setData(res.data.update); alert(res.data.message); }
            )  
    ...
    const searchHandler = e =>{
        e.preventDefault();
        console.log(search);
        axios.get('http://localhost:5000/allaluminis').then(res => 
            ...
            <nav className="navbar navbar-light">
                ...
                {presentuser === "admin" ?
                    <div>
                        ...
                        <form onSubmit={aluminisubmithandler} autoComplete="off">
                            ...
                            <small>Alumini collegeID must start with A- like A-19911A1234</small><br />

...
const Indprofile = () => {
    ...
    useEffect(()=>{
        axios.get(`http://localhost:5000/indprofilee/${id}`,{headers : {'x-token' : localStorage.getItem('token')}}).then(
                                    ...
                                    <center>
                                        <div className="  card" style={{"width":"20rem",textAlign:"center",boxShadow: "10px 10px 5px lightblue"}}><br />
                                            ...
                                            <form onSubmit={submitHandler}>
                                                <textarea style={{"width":"15rem"}} value={message} placeholder="Enter Message to This Profile" onChange={(e)=> setMessage(e.target.value)}  rows="2" cols="50"></textarea><br />

...
const Myprofile = () => {
    ...
    const x="http://localhost:5000/indprofile/"
    const y="http://localhost:5000/indprofile2/"
    ...
    const githubhandler = e =>{
        ...
        {
            axios.put(`http://localhost:5000/updatemygithub/${data._id}`,{newgithub:newgithub},{headers : {'x-token' : localStorage.getItem('token')}}).then(
    ...
    const linkedinhandler = e =>{
        ...
        {
            axios.put(`http://localhost:5000/updatemylinkedin/${data._id}`,{newlinkedin:newlinkedin},{headers : {'x-token' : localStorage.getItem('token')}}).then(
                response => {alert(response.data.message); setData(response.data.update); }
            )
            setNewlinkedin("")
        }
    ...
    const skillsubmithandler = e  =>{
        e.preventDefault();
        if(newskill){
            axios.put(`http://localhost:5000/updatemyprofile/${data._id}`,{newSkill:newskill},{headers : {'x-token' : localStorage.getItem('token')}}).then(
                response => {alert(response.data.message); setData(response.data.update)}
            );
        }
        setNewskill("")
    ...
    const descriptionsubmithandler = e  =>{
        e.preventDefault();
        if(description){
            axios.put(`http://localhost:5000/updatemydescription/${data._id}`,{ description:description },{headers : {'x-token' : localStorage.getItem('token')}}).then(
            response => {alert(response.data.message); setData(response.data.update)}
            );
        }
        else{
    ...
    const projectsubmithandler = e  =>{
        e.preventDefault();
        if(project){
            axios.put(`http://localhost:5000/updatemyproject/${data._id}`,{ project:project },{headers : {'x-token' : localStorage.getItem('token')}}).then(
                response => {
    ...
    {
        axios.put(`http://localhost:5000/msgblock/${index}`).then(
            response => {
                alert(response.data.message); 
                setData(response.data.update)
            }
    ...
    {
        axios.put(`http://localhost:5000/msgallow/${index}`).then(
            response => {
                alert(response.data.message); 
                setData(response.data.update)
            }
    ...
    const deleteHandler = id =>{
        axios.delete(`http://localhost:5000/delete/${id}`,{headers : {'x-token' : localStorage.getItem('token')}}).then(
          arr => alert(arr.data)          
        )
            ...
            {data ?
                <div className="profile bg-light card " style={{"margin":"10px"}}>
                                    ...
                                    <div>
                                        ...
                                        { g === 1 ? 
                                            <div>
                                                ...
                                                <small>https://github.com/ is must at starting and you cant be allowed to change it so make sure you give your permanent github profile</small><br />
                                    ...
                                    <div>
                                        ...
                                        { l === 1 ? 
                                            <div>
                                                ...
                                                <small>https://www.linkedin.com/ is must at starting and you cant be allowed to change it so make sure you give your permanent linkedin profile</small><br />
                    ...
                    {/* ------- description / Bio ------- */}
                                ...
                                <h1>Bio and path towards my skills:-</h1>
                                <center>
